...
// attack "object"
function Attack(x, y, first, second)
{
	this.x = x;
	this.y = y;
	this.first = first;
...
jQuery(document).ready(function()
{
	...
	var title_size = SCREEN_WIDTH * 0.033854167;
	...
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 1.33, SCREEN_HEIGHT / 4 * 1.25 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 1.66, SCREEN_HEIGHT / 4 * 1.25 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 2, SCREEN_HEIGHT / 4 * 1.25 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 2.33, SCREEN_HEIGHT / 4 * 1.25 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 2.66, SCREEN_HEIGHT / 4 * 1.25 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 1.33, SCREEN_HEIGHT / 4 * 2 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 1.66, SCREEN_HEIGHT / 4 * 2 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 2, SCREEN_HEIGHT / 4 * 2 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 2.33, SCREEN_HEIGHT / 4 * 2 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 2.66, SCREEN_HEIGHT / 4 * 2 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 1.33, SCREEN_HEIGHT / 4 * 2.75 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 1.66, SCREEN_HEIGHT / 4 * 2.75 * 4.5 / 5));
	attack_coords.push(new AttackPosition(SCREEN_WIDTH / 4 * 2, SCREEN_HEIGHT / 4 * 2.75 * 4.5 / 5));
...
fetchAttacks();
	...
	function fetchAttacks()
	{
		...
		{
			attacks[i].first.data("attack", false);
			attacks[i].second.data("attack", false);
		}

		var total_nodes_returned = 0;
		for (var i=0; i<teams.length; i++)
		{
			total_nodes_returned += nodes[i].length;
			if (total_nodes_returned > MAX_NUM_ATTACKS * 2)
				break;
		}
...
/*function getMac()
{
	...
	for (var i=0; i<6; i++)
	{
		mac += syms[Math.floor(Math.random() * syms.length)] + syms[Math.floor(Math.random() * syms.length)];
		if (i < 5)
			mac += ":";
	}
